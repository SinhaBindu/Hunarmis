    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(string id = "", string empid = "")
        {
            ...
            if (!string.IsNullOrWhiteSpace(id))
            {
                ...
                model.Id = tblu.Id;
                model.Name = tblu.EmpName;
                model.EmailId = tblu.Email;
                model.PhoneNo = tblu.PhoneNumber;
                model.DistrictID = tblu.DistrictId.Value;
                model.Password = tblu.PasswordHash;
                model.ConfirmPassword = tblu.PasswordHash;
                model.DistrictID = tblu.DistrictId.Value;
                model.RoleID = tblu.AspNetRoles.FirstOrDefault().Id;
            }
            return View(model);
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    var user = new ApplicationUser { PhoneNumber = model.PhoneNo.Trim(), UserName = model.PhoneNo.Trim(), Email = model.EmailId.Trim() };
                    model.Password = !string.IsNullOrWhiteSpace(model.Password) ? model.Password : model.PhoneNo;
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        if (db_.AspNetUsers.Any(x => x.Id == user.Id.Trim()))
                        {
                            ...
                            tbLu.EmpName = model.Name.Trim();
                            tbLu.DistrictId = model.DistrictID;
                            tbLu.IsActive = true;
